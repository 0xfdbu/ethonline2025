...
import { IntentVisualizer } from '../components/visualizer/IntentVisualizer';
import { ResultsCard } from '../components/visualizer/ResultsCard';
...
export const Visualizer: React.FC = () => {
  ...
  console.log('Render Visualizer: nodes', nodes.length, 'loading', loading);
