...
  <div className="flex-1 bg-white/15 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-4 space-y-3 min-w-0 w-full md:w-auto">
...
          {/* Fix for layout stacking on desktop: added md:items-start and enforced w-1/2 on md for children */}
          <div className="flex flex-col md:flex-row md:items-start items-center gap-4 w-full relative">
            <FromSection
              fromToken={fromToken}
...
        {/* Visualizer padding removal: removed overflow-x-auto and ensured it's just w-full */}
        <div className="w-full">
          <Visualizer
